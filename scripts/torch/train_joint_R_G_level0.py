...
if args.load_model:
    ...
    model = vxm.networks.VxmDense_joint_level0.load(args.load_model, device)
else:
#     # otherwise configure new model
    model = vxm.networks.VxmDense_joint_level0(
        inshape=inshape,
...
# netG_A2B = vxm.networks_cyclegan.Generator_mini(16, 16)
# netG_B2A = vxm.networks_cyclegan.Generator_mini(16, 16)
# netD_A = vxm.networks_cyclegan.Discriminator_mini(16)
# netD_B = vxm.networks_cyclegan.Discriminator_mini(16)

netG_A2B = vxm.networks_cyclegan.Generator(16, 16)
netG_B2A = vxm.networks_cyclegan.Generator(16, 16)
netD_A = vxm.networks_cyclegan.Discriminator(16)
netD_B = vxm.networks_cyclegan.Discriminator(16)
...
torch.save(netG_A2B.state_dict(), 'model_joint_R_G_level0_origin_cyclegan/netG_A2B.pth')
torch.save(netG_B2A.state_dict(), 'model_joint_R_G_level0_origin_cyclegan/netG_B2A.pth')
torch.save(netD_A.state_dict(), 'model_joint_R_G_level0_origin_cyclegan/netD_A.pth')
torch.save(netD_B.state_dict(), 'model_joint_R_G_level0_origin_cyclegan/netD_B.pth')
...
def every_epoch_val(best_dice):
    ...
    if best_dice < accurent_dice:
        ...
        model.save(os.path.join('model_joint_R_G_level0', '%04d_best.pt' % epoch))
        # save cyclegan
        torch.save(netG_A2B.state_dict(), 'model_joint_R_G_level0_origin_cyclegan/best_netG_A2B.pth')
        torch.save(netG_B2A.state_dict(), 'model_joint_R_G_level0_origin_cyclegan/best_netG_B2A.pth')
        torch.save(netD_A.state_dict(), 'model_joint_R_G_level0_origin_cyclegan/best_netD_A.pth')
        torch.save(netD_B.state_dict(), 'model_joint_R_G_level0_origin_cyclegan/best_netD_B.pth')
