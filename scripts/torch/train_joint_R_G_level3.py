...
if args.load_model:
    ...
    model = vxm.networks.VxmDense_joint_level3.load(args.load_model, device)
else:
#     # otherwise configure new model
    model = vxm.networks.VxmDense_joint_level3(
        inshape=inshape,
...
netD_A = vxm.networks_cyclegan.Discriminator_mini(32)
netD_B = vxm.networks_cyclegan.Discriminator_mini(32)
...
torch.save(netG_A2B.state_dict(), 'model_joint_R_G_level3/netG_A2B.pth')
torch.save(netG_B2A.state_dict(), 'model_joint_R_G_level3/netG_B2A.pth')
torch.save(netD_A.state_dict(), 'model_joint_R_G_level3/netD_A.pth')
torch.save(netD_B.state_dict(), 'model_joint_R_G_level3/netD_B.pth')
...
def every_epoch_val(best_dice):
    ...
    if best_dice < accurent_dice:
        ...
        model.save(os.path.join('model_joint_R_G_level3', '%04d_best.pt' % epoch))
        # save cyclegan
        torch.save(netG_A2B.state_dict(), 'model_joint_R_G_level3/best_netG_A2B.pth')
        torch.save(netG_B2A.state_dict(), 'model_joint_R_G_level3/best_netG_B2A.pth')
        torch.save(netD_A.state_dict(), 'model_joint_R_G_level3/best_netD_A.pth')
        torch.save(netD_B.state_dict(), 'model_joint_R_G_level3/best_netD_B.pth')
