...
class Generator(nn.Module):
    ...
    def forward(self, x):
        ...
        # print('self.model_gen',self.model)
        return self.model(x)
    
class Generator_mini(nn.Module):
    def __init__(self, input_nc, output_nc, n_residual_blocks=4):
        super(Generator_mini, self).__init__()
...
class Discriminator(nn.Module):
    ...
    def forward(self, x):
        # print('self.model_dis',self.model)
        x =  self.model(x)
...
class Discriminator_mini(nn.Module):
    def __init__(self, input_nc):
        super(Discriminator_mini, self).__init__()
